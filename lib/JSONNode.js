...
var _CollapsibleString = require('./CollapsibleString');

var _CollapsibleString2 = _interopRequireDefault(_CollapsibleString);
...
function getDiffValue(rawValue) {
  ...
  console.log('[getDiffValue] typeof rawValue: ' + (typeof rawValue === 'undefined' ? 'undefined' : (0, _typeof3['default'])(rawValue)));
  ...
  if (typeof rawValue === 'string') {
    ...
    var decodedValue = decodeURIComponent(splitValue[1]);
    ...
    case 'String':
      return _react2['default'].createElement(_JSONValueNode2['default'], (0, _extends3['default'])({}, simpleNodeProps, {
        ...
        valueRenderer: function valueRenderer(value) {
          if (!isDiffMode) {
            return _react2['default'].createElement(_CollapsibleString2['default'], {
              value: value,
              collapsibleStringIcons: rest.collapsibleStringIcons
            });
          } else {
            if (diffValues.type === 'ValueChanged') {
              return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_CollapsibleString2['default'], {
